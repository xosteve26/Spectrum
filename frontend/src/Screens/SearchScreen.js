      ...
      <>
          <section className="relative py-20 overflow-hidden bg-gradient-to-b from-black to-gray-900">
              ...
              <div className="relative px-16 mx-auto max-w-7xl">
                  <p className="font-medium tracking-wide text-green-500 uppercase">
                      RESULTS
                  </p>
                  <h2 className="text-gray-300 relative max-w-lg mt-5 mb-10 text-4xl font-semibold leading-tight lg:text-5xl">
                      Related <br />
                      searches
                  </h2>
                            ...
                            return(
                                    ...
                                    <Link to={`/song/${track.track.key}`} state={{ key: track.track.key }}>
                                        <div className="relative p-5" >
                                            <div className="bg-gray-700 absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-blue-50" />
                                            <img
                                        ...
                                        <div className="mt-3 space-y-2 text-center">
                                            <div className="space-y-1 text-lg font-medium leading-6">
                                                <h3 className='text-green-500'>{track.track.subtitle}</h3>
                                                <p className="text-gray-300">{track.track.title}</p>
                                            </div>
                                            <div className="relative flex items-center justify-center space-x-3">
                                                <a target="_blank" href={track.track.hub.options[0].actions[0].uri} className="text-gray-300 hover:text-gray-400">
                                                <img src="/apple-music.svg" className='h-10 w-10 rounded-full' />
                                                </a>
