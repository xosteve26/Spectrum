...
const RegisterationModal = ({ isOpenRegister, onCloseRegister, sw }) => {
    ...
    return (
        <Transition.Root show={isOpenRegister} as={Fragment}>
            <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={onCloseRegister}>
                <Transition.Child
                    as={Fragment}
