    ...
    return (
        <>
            <div className=" h-full w-full">
                            ...
                            <div className="flex">
                                <div className="hidden xl:flex md:mr-6 xl:mr-16">
                                    {!profile ? <>
                                        ...
                                        <li onClick={handleOpenLogin} className="cursor-pointer flex px-5 items-center py-6 text-sm leading-5 text-white transition duration-150 ease-in-out">
                                            <a href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:bg-gray-800 rounded-lg transition duration-150 ease-in-out">
                                            <span className="mr-2">
                                                    <img src="https://uxwing.com/wp-content/themes/uxwing/download/editing-user-action/private-icon.svg" className="rounded-full bg-white h-8 w-8" />
                                            </span>
                                            Login
                                            </a>
                                        </li>
                                        <li  onClick={handleOpenRegister} className="cursor-pointer flex px-5 items-center py-6 text-sm leading-5 text-white transition duration-150 ease-in-out">
                                        <a  href="javascript: void(0)" className="flex px-5 items-center py-6 text-sm leading-5 text-white hover:bg-gray-800 rounded-lg transition duration-150 ease-in-out">
                                            <span className="mr-2">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/7988/7988902.png" className="rounded-full bg-white h-8 w-8" />
                                            </span>
                                            Register
                                        </a>
                                        </li>
                                    </> : 
                                    <li className="cursor-pointer flex px-5 items-center py-6 text-sm leading-5 text-white transition duration-150 ease-in-out">
                                    <a href="/dashboard" className="rounded-lg flex px-5 items-center py-6 text-sm leading-5 text-white hover:bg-gray-800  transition duration-150 ease-in-out">
                                        <span className="mr-2">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/570/570170.png" className="bg-white h-6 w-6 rounded-lg" />
                                        </span>
                                        Dashboard
                                    </a>
                                    </li>
                                ...
                                <div className="hidden xl:flex items-center">
                                    ...
                                    <div className="ml-6 relative">
                                        <div className="flex items-center relative" onClick={() => setDropDown(!dropDown)}>
                                            {dropDown && (
                                                <>
                                                
                                                <ul className="p-2 w-40 border-r bg-white absolute rounded right-0 shadow top-0 mt-16 z-10">
                                                    <Link to={`/profile`}>
                                                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-green-500 focus:text-indigo-700 focus:outline-none">
                                                        <div className="flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                                <circle cx={12} cy={7} r={4} />
                                                    ...
                                                    <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-2 py-2 hover:text-green-500 focus:text-indigo-700 focus:outline-none flex items-center">
                                                        ...
                                                        <span className="ml-2" onClick={logoutHandler}>Logout</span>
                                                    </li>
                                            ...
                                            {profile && (
                                                <>
                                                    ...
                                                    <div className="cursor-pointer flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-white transition duration-150 ease-in-out">
                                                        <img className="rounded-full h-10 w-10 object-cover" src="/avatar-icon.png" alt="logo" />
                                                    </div>
                ...
                <nav>
                    <div className="py-2 px-6 w-full flex xl:hidden justify-between items-center bg-black fixed top-0 z-10">
                        <div className="w-24">
                            <a href="/"><img src="/Spectrum-logos_white.png" className="h-20 w-24" /></a>
                        </div>
                        <div className="flex items-center">
                    ...
                    <LoginModal isOpenLogin={openLogin} onCloseLogin={handleCloseLogin} sw={switchL_R} />
                    <RegisterationModal isOpenRegister={openRegister} onCloseRegister={handleCloseRegister} sw={switchL_R} />
                                    ...
                                    <div>
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    <a href="/"><img src="/Spectrum-logos_white.png" className="h-32 w-32" /></a>
                                    ...
                                    <div className="w-full pt-4">
                                        ...
                                        <div className="border-t border-gray-300">
                                            <div className="w-full flex items-center justify-between pt-1">
                                                <div className="flex items-center">
                                                    <img alt="profile-pic" src="/avatar-icon.png" className="w-8 h-8 rounded-md" />
